...
const page = () => {
  ...
  return (
    ...
    <p className=" text-[#000103] font-bold text-[31px] leading-tight">Tell us about your business</p>
    ...
    <form className=" flex flex-col w-full text-[#8f8f8f] gap-9">
        ...
        <button onClick={handleSubmit} className={` ${industry.length > 1 ? 'bg-[#0030AD] text-white' : 'bg-[#D5D9EA] text-[rgba(0,1,3,0.39)]'}  rounded-[8px] py-3 font-bold `}>{industry.length < 1 ? 'Get started' : 'Next'}</button>
