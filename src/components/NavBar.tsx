...
function NavBar() {
  return (
    <>
    <div className='sticky top-0 lg:flex bg-white hidden justify-between items-center  lg:py-[30px]'>
    ...
    <div className='flex lg:hidden items-center justify-between fixed w-full py-4 top-0 left-0  px-5 bg-white'>
