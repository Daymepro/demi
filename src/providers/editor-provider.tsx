...
export type EditorButton = 'text' | 'container' | 'section' | 'contactForm' | 'paymentForm' | 'link' | '2Col' | 'video' | '__body' | 'image' | null | '3Col'
...
const editorReducer = (
    ...
    switch (action.type) {
      ...
      case 'LOAD_LOCALSTORAGE': 
        const dataFromStorage = localStorage.getItem(action.payload.elementDetails.funnelPageId)
